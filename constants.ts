...
import type { User, Case, EvidenceDocument, Notification, Appointment, ActivityLog, Message, Review } from './types';
...
// A single source of truth for all users to simulate a database.
export const ALL_USERS: User[] = [
  ...
  },
  {
    ...
    rating: 4.9,
    reviews: [
        { reviewerName: 'John Doe', rating: 5, comment: 'Farida was compassionate and extremely effective in my family law case. I couldn\'t have asked for better representation.', timestamp: Date.now() - 5 * 24 * 3600 * 1000 },
